  ...
  const faqs = [
    {
      ...
      answer: 'Yes! The cidery is open Friday - Sunday, 12 - 5 pm, and we are open Labor Day, Monday September 7, 12 - 5 pm.',
    },
    {
      icon: (
        <svg className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      answer: 'For 2026, the farm, gift shop, and cidery open April 24th. Friday - Sunday: 12 - 5 pm, plus Labor Day, Monday September 7: 12 - 5 pm. Extended hours during Lavender Festival Weekend (July 17-20): 10 am - 5 pm.',
    },
  ];
